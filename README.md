...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nasa-open-apis` | `npm install @voxgig-sdk/nasa-open-apis` |
| Python | `voxgig-sdk-nasa-open-apis` | `pip install voxgig-sdk-nasa-open-apis` |
| PHP | `voxgig-sdk/nasa-open-apis` | `composer require voxgig-sdk/nasa-open-apis` |
| Golang | `github.com/voxgig-sdk/nasa-open-apis-sdk/go` | `go get github.com/voxgig-sdk/nasa-open-apis-sdk/go` |
| Ruby | `voxgig-sdk-nasa-open-apis` | `gem install voxgig-sdk-nasa-open-apis` |
| Lua | `voxgig-sdk-nasa-open-apis` | `luarocks install voxgig-sdk-nasa-open-apis` |
