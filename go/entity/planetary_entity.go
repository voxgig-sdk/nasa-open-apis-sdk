...
type PlanetaryEntity struct {
	name    string
	client  *core.NasaOpenApisSDK
...
func NewPlanetaryEntity(client *core.NasaOpenApisSDK, entopts map[string]any) *PlanetaryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlanetaryEntity) GetName() string { return e.name }
...
func (e *PlanetaryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlanetaryEntity) Deleted() bool {
	return e.deleted
}


func (e *PlanetaryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlanetaryEntity(e.client, opts)
}

func (e *PlanetaryEntity) Data(args ...any) any {
...
func (e *PlanetaryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Planetary; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlanetaryEntity) DataTyped(data ...Planetary) Planetary {
	if len(data) > 0 {
		return typedFrom[Planetary](e.Data(asMap(data[0])))
	}
	return typedFrom[Planetary](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Planetary (all fields
// optional at the wire level).
func (e *PlanetaryEntity) MatchTyped(match ...Planetary) Planetary {
	if len(match) > 0 {
		return typedFrom[Planetary](e.Match(asMap(match[0])))
	}
	return typedFrom[Planetary](e.Match())
}
...
func (e *PlanetaryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlanetaryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlanetaryLoadMatch and returns an Planetary. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlanetaryEntity) LoadTyped(reqmatch PlanetaryLoadMatch, ctrl map[string]any) (Planetary, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Planetary{}, err
	}
	return typedFrom[Planetary](res), nil
}



func (e *PlanetaryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PlanetaryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlanetaryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlanetaryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlanetaryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
