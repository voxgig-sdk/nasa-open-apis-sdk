...
func NewMarsPhotoEntity(client *core.NasaOpenApisSDK, entopts map[string]any) *MarsPhotoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarsPhotoEntity) GetName() string { return e.name }
...
func (e *MarsPhotoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarsPhotoEntity) Deleted() bool {
	return e.deleted
}


func (e *MarsPhotoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarsPhotoEntity(e.client, opts)
}

func (e *MarsPhotoEntity) Data(args ...any) any {
...
func (e *MarsPhotoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MarsPhoto; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarsPhotoEntity) DataTyped(data ...MarsPhoto) MarsPhoto {
	if len(data) > 0 {
		return typedFrom[MarsPhoto](e.Data(asMap(data[0])))
	}
	return typedFrom[MarsPhoto](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MarsPhoto (all fields
// optional at the wire level).
func (e *MarsPhotoEntity) MatchTyped(match ...MarsPhoto) MarsPhoto {
	if len(match) > 0 {
		return typedFrom[MarsPhoto](e.Match(asMap(match[0])))
	}
	return typedFrom[MarsPhoto](e.Match())
}
...
func (e *MarsPhotoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarsPhotoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MarsPhotoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarsPhotoListMatch and returns []MarsPhoto. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MarsPhotoEntity) ListTyped(reqmatch MarsPhotoListMatch, ctrl map[string]any) ([]MarsPhoto, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[MarsPhoto](res), nil
}



func (e *MarsPhotoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MarsPhotoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MarsPhotoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MarsPhotoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
