...
const testSeed = `map[string]any{"entity": map[string]any{"mars_photo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "planetary": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
