...
func (sdk *NasaOpenApisSDK) OptionsMap() map[string]any {
...
func (sdk *NasaOpenApisSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NasaOpenApisSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NasaOpenApisSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NasaOpenApisSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NasaOpenApisSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NasaOpenApisSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NasaOpenApisSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NasaOpenApisSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NasaOpenApisSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NasaOpenApisSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *NasaOpenApisSDK {
	...
	sdk := NewNasaOpenApisSDK(sdkopts)
	sdk.Mode = "test"
