...
// instead of `sdk.NewNasaOpenApisSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NasaOpenApisSDK  { return NewNasaOpenApisSDK(nil) }
func Test() *NasaOpenApisSDK { return TestSDK(nil, nil) }
