...
from nasaopenapis_sdk.utility import register

# Load features
from nasaopenapis_sdk.feature.base_feature import NasaOpenApisBaseFeature
from nasaopenapis_sdk.features import _has_feature, _make_feature
...
class NasaOpenApisSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NasaOpenApisUtility()
        self._utility = utility

        from nasaopenapis_sdk.config import shared_config
    ...
    def get_utility(self):
        return NasaOpenApisUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NasaOpenApisSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def MarsPhoto(self, data=None) -> "MarsPhotoEntity":
        ...
        from nasaopenapis_sdk.entity.mars_photo_entity import MarsPhotoEntity
    ...
    def Planetary(self, data=None) -> "PlanetaryEntity":
        ...
        from nasaopenapis_sdk.entity.planetary_entity import PlanetaryEntity
