# NasaOpenApis SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NasaOpenApisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NasaOpenApisSDK(...) and NasaOpenApisSDK.test(...) become
#      NasaOpenApisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nasaopenapis_sdk"
_SDK_CLASS = "NasaOpenApisSDK"
