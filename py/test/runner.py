...
class NasaOpenApisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NasaOpenApisTestRunner.getenv("NASAOPENAPIS_TEST_LIVE")
        override = NasaOpenApisTestRunner.getenv("NASAOPENAPIS_TEST_OVERRIDE")
        ...
        explain = NasaOpenApisTestRunner.getenv("NASAOPENAPIS_TEST_EXPLAIN")
