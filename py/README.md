# NasaOpenApis Python SDK



The Python SDK for the NasaOpenApis API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.MarsPhoto()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/nasa-open-apis-sdk/releases)) or
...
```
py/
├── nasaopenapis_sdk.py         -- Main SDK module
