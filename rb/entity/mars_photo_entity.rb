...
class MarsPhotoEntity
  ...
  def make
    opts = @_entopts.dup
    MarsPhotoEntity.new(@_client, opts)
  end
  ...
  # @return [MarsPhoto, Hash] the current MarsPhoto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MarsPhoto fields)
  def match_get
  ...
  #
  # @param reqmatch [MarsPhotoListMatch, Hash, nil] match filter (any subset of
  #   MarsPhoto fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MarsPhoto>, Array] the matching MarsPhoto items; raises NasaOpenApisError on failure
