# NasaOpenApis Ruby SDK



The Ruby SDK for the NasaOpenApis API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `NasaOpenApisError` (a `StandardError` subclass), so wrap
...
| `rover` | `Hash` |  |
| `sol` | `Integer` | Martian sol when the photo was taken |
...
```
rb/
├── NasaOpenApis_sdk.rb       -- Main SDK module
...
The main module (`NasaOpenApis_sdk`) exports the SDK class
