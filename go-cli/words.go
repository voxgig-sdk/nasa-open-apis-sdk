...
func registerSDKWords(r *eng.Registry, client *sdk.NasaOpenApisSDK) {
...
func runOp(client *sdk.NasaOpenApisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
