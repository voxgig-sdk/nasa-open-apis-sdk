// Command NasaOpenApis-mcp is an MCP server exposing the NasaOpenApis
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NasaOpenApis_list  — list records of an entity
//	NasaOpenApis_load  — load a single record of an entity
//
