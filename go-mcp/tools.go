...
type Args struct {
	Entity string         `json:"entity" jsonschema:"mars_photo | planetary"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NasaOpenApisSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nasa-open-apis_list",
		Description: "List records from NasaOpenApis. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nasa-open-apis_load",
		Description: "Load a single record from NasaOpenApis. " +
...
func runOp(client *sdk.NasaOpenApisSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NasaOpenApisSDK, name string) (sdk.NasaOpenApisEntity, error) {
	switch strings.ToLower(name) {
	case "mars_photo":
		return client.MarsPhoto(nil), nil
	case "planetary":
		return client.Planetary(nil), nil
