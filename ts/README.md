# NasaOpenApis TypeScript SDK



The TypeScript SDK for the NasaOpenApis API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.MarsPhoto()` — each with a small set of operations (`list`, `load`)
...
```ts
const client = new NasaOpenApisSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `NasaOpenApisSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `NasaOpenApisSDK.test(testopts?, sdkopts?)` | `NasaOpenApisSDK` | Create a test-mode client. |
...
| `client` | `client(): NasaOpenApisSDK` | Return the parent SDK client. |
...
nasa-open-apis/
├── src/
│   ├── NasaOpenApisSDK.ts        # Main SDK class
