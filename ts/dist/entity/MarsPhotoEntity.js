...
class MarsPhotoEntity extends NasaOpenApisEntityBase_1.NasaOpenApisEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'mars_photo';
        this.name_ = 'mars_photo';
        this.Name = 'MarsPhoto';
    }
    make() {
        return new MarsPhotoEntity(this._client, this.entopts());
    }
...
exports.MarsPhotoEntity = MarsPhotoEntity;
//# sourceMappingURL=MarsPhotoEntity.js.map