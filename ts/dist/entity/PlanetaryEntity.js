...
exports.PlanetaryEntity = void 0;
const NasaOpenApisEntityBase_1 = require("../NasaOpenApisEntityBase");
// TODO: needs Entity superclass
class PlanetaryEntity extends NasaOpenApisEntityBase_1.NasaOpenApisEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'planetary';
        this.name_ = 'planetary';
        this.Name = 'Planetary';
    }
    make() {
        return new PlanetaryEntity(this._client, this.entopts());
    }
...
exports.PlanetaryEntity = PlanetaryEntity;
//# sourceMappingURL=PlanetaryEntity.js.map