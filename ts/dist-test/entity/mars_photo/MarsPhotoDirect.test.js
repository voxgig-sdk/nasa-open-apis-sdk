...
(0, node_test_1.describe)('MarsPhotoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NasaOpenApisSDK({
    ...
    (0, node_test_1.test)('direct-list-mars_photo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-mars_photo', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["rover01"]))
            return;
...
function liveScenariosActive() { return false && process.env.NASA_OPEN_APIS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NasaOpenApisSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.NASA_OPEN_APIS_APIKEY,
        }));
        let idmap = env['NASA_OPEN_APIS_TEST_MARS_PHOTO_ENTID'];
    ...
    const client = new __1.NasaOpenApisSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MarsPhotoDirect.test.js.map