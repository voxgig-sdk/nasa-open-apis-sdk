...
(0, node_test_1.describe)('PlanetaryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-planetary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-planetary', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NASA_OPEN_APIS_TEST_PLANETARY_ENTID'];
...
//# sourceMappingURL=PlanetaryDirect.test.js.map