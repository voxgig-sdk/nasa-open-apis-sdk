...
function envOverride(m) {
    if ('TRUE' === process.env.NASA_OPEN_APIS_TEST_LIVE ||
        'TRUE' === process.env.NASA_OPEN_APIS_TEST_OVERRIDE) {
    ...
    m.NASA_OPEN_APIS_TEST_EXPLAIN = process.env.NASA_OPEN_APIS_TEST_EXPLAIN || m.NASA_OPEN_APIS_TEST_EXPLAIN;
    return m;
}
