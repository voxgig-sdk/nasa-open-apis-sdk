...
local PlanetaryEntity = {}
PlanetaryEntity.__index = PlanetaryEntity


function PlanetaryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PlanetaryEntity)
  self._name = "planetary"
  self._client = client
...
function PlanetaryEntity:get_name()
  return self._name
end


function PlanetaryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PlanetaryEntity.new(self._client, opts)
end
...
function PlanetaryEntity:mark_deleted()
  self._deleted = true
end


function PlanetaryEntity:deleted()
  return true == self._deleted
end


function PlanetaryEntity:data_set(args)
  if args ~= nil then
...
function PlanetaryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PlanetaryEntity:match_set(args)
  if args ~= nil then
...
function PlanetaryEntity:match_get()
...
function PlanetaryEntity:stream(action, args, callopts)
...
---@param reqmatch PlanetaryLoadMatch
---@param ctrl? table
---@return Planetary
---@return string? err
function PlanetaryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PlanetaryEntity:_run_op(ctx, post_done)
  local utility = self._utility
