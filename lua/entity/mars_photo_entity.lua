...
local MarsPhotoEntity = {}
MarsPhotoEntity.__index = MarsPhotoEntity


function MarsPhotoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MarsPhotoEntity)
  self._name = "mars_photo"
  self._client = client
...
function MarsPhotoEntity:get_name()
  return self._name
end


function MarsPhotoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MarsPhotoEntity.new(self._client, opts)
end
...
function MarsPhotoEntity:mark_deleted()
  self._deleted = true
end


function MarsPhotoEntity:deleted()
  return true == self._deleted
end


function MarsPhotoEntity:data_set(args)
  if args ~= nil then
...
function MarsPhotoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MarsPhotoEntity:match_set(args)
  if args ~= nil then
...
function MarsPhotoEntity:match_get()
...
function MarsPhotoEntity:stream(action, args, callopts)
...
function MarsPhotoEntity:_run_op(ctx, post_done)
  local utility = self._utility
