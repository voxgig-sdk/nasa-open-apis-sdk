...
function runner.env_override(m)
  local live = runner.getenv("NASAOPENAPIS_TEST_LIVE")
  local override = runner.getenv("NASAOPENAPIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NASAOPENAPIS_TEST_EXPLAIN")
