...
function runner.env_override(m)
  local live = runner.getenv("NASA_OPEN_APIS_TEST_LIVE")
  local override = runner.getenv("NASA_OPEN_APIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NASA_OPEN_APIS_TEST_EXPLAIN")
