...
describe("PlanetaryDirect", function()
  it("should direct-load-planetary", function()
    local setup = planetary_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-planetary", setup.live and "live" or "unit")
...
function planetary_direct_setup(mockres)
