...
// NasaOpenApis SDK utility type

class NasaOpenApisUtility
{
    ...
    public static function copy(NasaOpenApisUtility $src): NasaOpenApisUtility
    {
        $u = new NasaOpenApisUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
