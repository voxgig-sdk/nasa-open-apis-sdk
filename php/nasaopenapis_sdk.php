...
class NasaOpenApisSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = NasaOpenApisHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NasaOpenApisHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!NasaOpenApisFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, NasaOpenApisFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NasaOpenApisUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NasaOpenApisHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NasaOpenApisHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NasaOpenApisHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new NasaOpenApisError($op . "_allow",
                "NasaOpenApisSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NasaOpenApisHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new NasaOpenApisError("graphql_error",
                "NasaOpenApisSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function MarsPhoto($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_mars_photo === null) {
                $this->_mars_photo = new MarsPhotoEntity($this, null);
            }
            return $this->_mars_photo;
        }
        return new MarsPhotoEntity($this, $data);
    }
    ...
    public function Planetary($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_planetary === null) {
                $this->_planetary = new PlanetaryEntity($this, null);
            }
            return $this->_planetary;
        }
        return new PlanetaryEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new NasaOpenApisSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
