# NasaOpenApis PHP SDK Reference

Complete API reference for the NasaOpenApis PHP SDK.
...
#### `NasaOpenApisSDK::test($testopts = null, $sdkopts = null)`
...
Create a new `MarsPhotoEntity` instance. Pass `null` for no initial data.
