...
// NasaOpenApis SDK MarsPhoto entity
...
class MarsPhotoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarsPhotoEntity($this->_client, $opts);
    }

    /**
     * @param MarsPhoto|array $args MarsPhoto data (assoc-array) to store.
     */
    ...
    /**
     * @return MarsPhoto|array The current MarsPhoto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MarsPhoto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MarsPhoto fields).
     */
    ...
    /**
     * List MarsPhoto items matching the given filter.
     *
     * @param MarsPhotoListMatch|array|null $reqmatch Match filter (any subset
     *   of MarsPhoto fields) as an assoc-array; MarsPhotoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarsPhoto[]|array A list of MarsPhoto items as assoc-arrays at
     *   the SDK boundary; throws NasaOpenApisError on failure (item-5 convention).
     */
