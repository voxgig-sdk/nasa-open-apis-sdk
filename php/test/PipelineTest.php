...
// NasaOpenApis SDK pipeline test
//
...
{
    private static function utility(): NasaOpenApisUtility
    {
        return new NasaOpenApisUtility();
    }
    ...
    private static function ctx(array $over = []): NasaOpenApisContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NasaOpenApisContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NasaOpenApisOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NasaOpenApisError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NasaOpenApisOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NasaOpenApisMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NasaOpenApisOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NasaOpenApisMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NasaOpenApisOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NasaOpenApisMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NasaOpenApisSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NasaOpenApisMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NasaOpenApisResponse([]),
            'result' => new NasaOpenApisResult([]),
        ]);
        [, $err] = NasaOpenApisMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NasaOpenApisSpec([]),
            'response' => null,
            'result' => new NasaOpenApisResult([]),
        ]);
        [, $err] = NasaOpenApisMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NasaOpenApisSpec(['step' => 's']),
            'response' => new NasaOpenApisResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NasaOpenApisResult([]),
        ]);
        [, $err] = NasaOpenApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NasaOpenApisSpec(['step' => 's']),
            'response' => new NasaOpenApisResponse(self::resp(200, ['v' => 1])),
            'result' => new NasaOpenApisResult([]),
        ]);
        [, $err] = NasaOpenApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NasaOpenApisSpec(['step' => 's']),
            'response' => new NasaOpenApisResponse(self::resp(200, ['v' => 2])),
            'result' => new NasaOpenApisResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NasaOpenApisMakeResponse::call($ctx);
    ...
    {
        $preset = new NasaOpenApisResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NasaOpenApisSpec([]),
            'response' => new NasaOpenApisResponse([]),
            'result' => new NasaOpenApisResult([]),
        ...
        [$got, $err] = NasaOpenApisMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NasaOpenApisResult([])]);
        [, $err] = NasaOpenApisMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NasaOpenApisSpec([]), 'result' => null]);
        [, $err] = NasaOpenApisMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NasaOpenApisSpec(['step' => 's']),
            'result' => new NasaOpenApisResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NasaOpenApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NasaOpenApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NasaOpenApisSpec(['step' => 's']),
            'result' => new NasaOpenApisResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NasaOpenApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NasaOpenApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NasaOpenApisResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NasaOpenApisSpec([]),
            'result' => new NasaOpenApisResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NasaOpenApisMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NasaOpenApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NasaOpenApisError('boom', 'boom');
        $utility->fetcher = function (NasaOpenApisContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NasaOpenApisSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NasaOpenApisMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NasaOpenApisContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NasaOpenApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NasaOpenApisResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NasaOpenApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NasaOpenApisContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NasaOpenApisSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NasaOpenApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NasaOpenApisResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NasaOpenApisSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NasaOpenApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NasaOpenApisMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NasaOpenApisMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NasaOpenApisResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NasaOpenApisDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NasaOpenApisResult(['ok' => false])]);
        $this->expectException(NasaOpenApisError::class);
        NasaOpenApisDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NasaOpenApisResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NasaOpenApisMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NasaOpenApisMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NasaOpenApisBaseFeature();
        $b = new NasaOpenApisBaseFeature();
        NasaOpenApisFeatureAdd::call($ctx, $a);
        NasaOpenApisFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NasaOpenApisBaseFeature
    {
        $f = new NasaOpenApisBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NasaOpenApisFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NasaOpenApisContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NasaOpenApisSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NasaOpenApisPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NasaOpenApisPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NasaOpenApisResponse(['headers' => null]),
            'result' => new NasaOpenApisResult([]),
        ]);
        NasaOpenApisResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NasaOpenApisResultBody::call($ctx);
