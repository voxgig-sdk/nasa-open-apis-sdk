...
class PlanetaryDirectTest extends TestCase
{
    public function test_direct_load_planetary(): void
    {
        $setup = planetary_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-planetary", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
