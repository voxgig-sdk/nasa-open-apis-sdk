...
// NasaOpenApis SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NasaOpenApisSDK::test)
...
{
    private const SDK_CLASS = 'NasaOpenApisSDK';
    ...
    private const SDK_BASE = 'nasaopenapis_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nasaopenapis_sdk.php';
