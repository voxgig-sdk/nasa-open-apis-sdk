...
// NasaOpenApis SDK audit feature
...
class NasaOpenApisAuditFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _emit(NasaOpenApisContext $ctx, string $outcome): void
    {
