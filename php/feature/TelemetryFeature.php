...
// NasaOpenApis SDK telemetry feature
...
class NasaOpenApisTelemetryFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _close(NasaOpenApisContext $ctx, bool $ok): void
    {
