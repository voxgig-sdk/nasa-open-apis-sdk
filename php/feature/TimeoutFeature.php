...
// NasaOpenApis SDK timeout feature
...
class NasaOpenApisTimeoutFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _with_timeout(NasaOpenApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NasaOpenApisContext $_ctx, float $ms): void
    {
        $client = $this->client;
