...
class NasaOpenApisRbacFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _required(NasaOpenApisContext $ctx): ?string
    {
    ...
    private function _reject(NasaOpenApisContext $ctx, string $required): void
    {
    ...
    private function _track(NasaOpenApisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
