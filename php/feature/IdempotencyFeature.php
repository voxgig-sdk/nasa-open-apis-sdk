...
// NasaOpenApis SDK idempotency feature
...
class NasaOpenApisIdempotencyFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _mutating(NasaOpenApisContext $ctx): bool
    {
