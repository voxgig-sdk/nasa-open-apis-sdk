...
// NasaOpenApis SDK ratelimit feature
...
class NasaOpenApisRatelimitFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _acquire(NasaOpenApisContext $ctx): void
    {
    ...
    private function _track(NasaOpenApisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
