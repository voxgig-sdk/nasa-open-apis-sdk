...
// NasaOpenApis SDK streaming feature
...
class NasaOpenApisStreamingFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _iterate(NasaOpenApisResult $result): \Generator
    {
    ...
    private function _streamable(NasaOpenApisContext $ctx): bool
    {
