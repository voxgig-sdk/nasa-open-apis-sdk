...
// NasaOpenApis SDK clienttrack feature
...
class NasaOpenApisClienttrackFeature extends NasaOpenApisBaseFeature
{
    ...
    public function PostConstruct(NasaOpenApisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NasaOpenApis-SDK';
