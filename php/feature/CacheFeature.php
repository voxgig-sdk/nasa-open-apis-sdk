...
// NasaOpenApis SDK cache feature
...
class NasaOpenApisCacheFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _through(NasaOpenApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
