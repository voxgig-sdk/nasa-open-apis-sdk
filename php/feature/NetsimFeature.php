...
// NasaOpenApis SDK netsim feature
...
class NasaOpenApisNetsimFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _simulate(NasaOpenApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NasaOpenApisContext $ctx, array $applied): void
    {
        $client = $this->client;
