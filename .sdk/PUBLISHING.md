...
|---|---|---|
| `ts/` | @voxgig-sdk/nasa-open-apis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nasa-open-apis-sdk \
      --repository voxgig-sdk/nasa-open-apis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nasa-open-apis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nasa-open-apis-sdk --id=<id>` removes it.
