...
class NasaOpenApisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NasaOpenApisTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NasaOpenApisTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NasaOpenApisTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
