...
// NasaOpenApis SDK metrics feature
...
class NasaOpenApisMetricsFeature extends NasaOpenApisBaseFeature
{
    ...
    private function _record(NasaOpenApisContext $ctx, bool $ok): void
    {
