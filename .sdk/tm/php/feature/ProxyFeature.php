...
// NasaOpenApis SDK proxy feature
...
class NasaOpenApisProxyFeature extends NasaOpenApisBaseFeature
{
    ...
    public function init(NasaOpenApisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NasaOpenApisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
