...
// NasaOpenApis SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NasaOpenApisTransformResponse
{
    public static function call(NasaOpenApisContext $ctx): mixed
    {
        ...
        $transform = NasaOpenApisHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
