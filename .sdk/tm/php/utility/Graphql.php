...
// NasaOpenApis SDK utility: graphql
//
...
class NasaOpenApisGraphql
{
    ...
    // equivalent.
    public static function body(NasaOpenApisContext $ctx): mixed
    {
    ...
    public static function errors(NasaOpenApisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
