...
// NasaOpenApis SDK utility: fetcher

class NasaOpenApisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NasaOpenApisSDK/1.0)';
    ...
    public static function call(NasaOpenApisContext $ctx, string $fullurl, array $fetchdef): array
    {
