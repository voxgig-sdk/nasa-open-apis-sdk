...
// NasaOpenApis SDK utility: make_options

class NasaOpenApisMakeOptions
{
    ...
    public static function call(NasaOpenApisContext $ctx): array
    {
        ...
        //
        // `NasaOpenApisSchema::optspec()` is built from the model:
        ...
        $optspec = NasaOpenApisSchema::optspec();
